...
What it does not do is make an individual request return faster. That trade is deliberate, and [Building for async inference](/async-inference) explains why it's the right one for async work.
