...
<Warning>
  Expect this to take seconds rather than milliseconds, and longer under load. The generous timeout is deliberate — SDK defaults are tuned for interactive providers and will abort early.
</Warning>
