...
| Term | Meaning |
| --- | --- |
| **Serverless** | Inference on Impala's cloud, no install. See [Run in your cloud, or ours](/deployment-options). |
| **BYOC** | Impala's data plane running inside your own cloud. See [Run in your cloud, or ours](/deployment-options). |
