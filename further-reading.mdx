...
**[Run It Hot](https://www.getimpala.ai/blog/run-it-hot)** — Why utilization, not electricity price, is the lever on cost per token. Doubling throughput halves cost per million tokens; halving your power price moves it about five percent. The arithmetic behind [Building for async inference](/async-inference).
